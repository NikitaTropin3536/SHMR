package com.example.settings.presentation.ui.language
...
fun LanguageSettingView (
    ...
    Column(
        ...
        Text(text = stringResource(com.example.settings.R.string.choose_lang))
        ...
        Row(
            ...
            Button(
                ...
                Text(text = stringResource(com.example.settings.R.string.english))
            }
            ...
            Button(
                ...
                Text(text = stringResource(com.example.settings.R.string.russian))
            }
