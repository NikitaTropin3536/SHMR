...
import com.example.common.core.model.graphics.PieChartItem
...
import com.example.common.ui.graphics.DrawCircleGraphWithIcon
...
import com.example.transations.R
...
fun AnalysisView (
    ...
    Column (
        ...
        FinDatePicker(
            title = stringResource(R.string.pediod_start),
        ...
        FinDatePicker(
            title = stringResource(R.string.pediod_end),
        ...
        if (state.transactions.isNotEmpty()) {
            ...
            FinButton(
                text = stringResource(R.string.change_view_chart),
