...
fun HistoryExpensesView (
    ...
    Column (
        ...
        FinDatePicker (
            title = stringResource(com.example.transations.R.string.begin),
        ...
        FinDatePicker (
            title = stringResource(com.example.transations.R.string.end),
        ...
        if (state.accounts.isNotEmpty()) {
            FinListItem(
                title = stringResource(com.example.transations.R.string.sum),
                description = null,
                backgroundColor = MaterialTheme.colorScheme.surfaceContainerLow,
